...
const pageText = {
  paraOne: `Hello !! My name is Stevenson Nelli. I'm an application developer who is
    passionate about various web technologies. I like to experiment with different web
    technologies. I have an experience of nearly 6 years working with MEAN stack, ExtJS, Angular, React and Typescript.`,
    ...
    <>
      <div>
        <SEO
          ...
          path=""
          keywords={['Stevenson', 'Nelli', 'FullStack developer', 'Javascript', 'ReactJS', 'NodeJS', 'Gatsby']}
        />
      ...
      <Row gutter={[20, 20]}>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
            ...
            textH3="Purushothapalli, AP, India"
          />
        </Col>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
